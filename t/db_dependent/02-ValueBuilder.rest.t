...
subtest("Scenario: Concis itemcallnumber generation API call.", sub {
    ...
    subtest("And a MARC Record with call numbers and a signum", sub {
        ...
        $biblionumber = C4::Biblio::AddBiblio(MARC::Record->new_from_xml(<<MARC
...
, 'UTF-8', 'MARC21'));
    ...
    subtest "GET /value-builder/concis-itemcallnumber" => sub {
        ...
        $t->get_ok($host.'/api/v1/contrib/value-builder/concis-itemcallnumber?biblionumber=9999'.$biblionumber)
        ->status_is('400')
